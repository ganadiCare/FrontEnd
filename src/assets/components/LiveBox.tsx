    ...
    <div className="live-wrapper">
      <div className="live-box">
        ...
        <div className='live-control'>
          {/* 우측 상단 태양(밝기) 아이콘 */}
          <div className={streaming ? "brightness-icon" : "brightness-icon hide"}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2">
              {streaming?.nightVision ? (
          ...
          {/* 중앙 플레이 버튼 */}
          <div
          className={streaming && !liveOn ? 'live-button' :"live-button hide"}
          ...
          {/* 미연결 표시 */}
          <div
          className={!streaming ? 'live-button' :"live-button hide"}
          >
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" strokeLinejoin="round" >
          ...
          {/* 전체화면 아이콘 */}
          <div
          className= {streaming && isLive ? 'full-icon' : 'full-icon hide'}
          >
