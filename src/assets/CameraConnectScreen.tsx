...
const CameraConnectScreen: React.FC<CameraScreenProps> = (
  {camList = [{deviceId: 1, deviceName: 'camera_cam1', deviceCode:1111001111, isMain: true}]}
) => {
      ...
      {camList?.map((item) => (
        <div className='list-box center'>
          ...
          <div className='list-option'>
            <svg className={item.isMain ? '' : 'hide'}
              width="20" height="20" viewBox="0 0 20 20" fill="none">
              <path d="M2 16H18V18H2V16ZM2 6L6 10L10 3L14 10L18 6V14H2V6Z" fill="#FFD700" />
            </svg>
      ...
      <main className="main-content">
        <section className="main-section">
          <div className='heading-wrapper'>
            <h3 className='section-heading'>카메라 연결</h3>
          </div>
